...
| Data Analysis Notebook | A public notebook of some analytical work with datasets | [Link](https://github.com/danielrosehill/Data-Analysis-Notebook-Public) |
...
| GHG Emissions Monetisation Calculato (Streamlit) | Calculation simulation utility for monetised GHG emissions | [Link](https://github.com/danielrosehill/GHG-Emissions-Monetisation-Calculator) |
...
| Hebrew Google Fonts Downloader | A utility for downloading Hebrew fonts from Google Fonts using the API (needs a key) | [Link](https://github.com/danielrosehill/Google-Fonts-Hebrew-Downloader) |
| Home Assistant Shabbat And Yom Tov Dashboard | A Shabbat/Yom Tov dashboard for Home Assistant utilizing the modifications I've documented elsewhere here.  | [Link](https://github.com/danielrosehill/Home-Assistant-Shabbat-Yom-Tov-Dashboard) |
...
| LLM API Price Estimates | Some cost estimates for using LLMs via API versus web UI services (like ChatGPT) | [Link](https://github.com/danielrosehill/LLM-API-Price-Estimates) |
| LLM Code Generation Benchmark Tests | Testing various large language models (LLMs) at programatically generating Python GUIs from natural language prompts | [Link](https://github.com/danielrosehill/LLM-Code-Generation-Tests) |
...
| My LLM Context Repo (Public Version) | A context repo for experimenting with LLM models. A public version, so some info naturally withheld. | [Link](https://github.com/danielrosehill/My-LLM-Context-Repo-Public) |
